...
strFileName = '/Users/mariakot/Desktop/Python UW/Assignments/Assignment05/CDInventory.txt'  # data storage file
...
while True:
    ...
    if strChoice == 'x':
        ...
        # 4. Display the current data from the memory to the user each time the user wants to display the data
        print('ID, CD Title, Artist')
        for row in lstTbl:
            print(*row.values(), sep = ',')
    
    elif strChoice == 'd':
        # 5. Delete the entry from the memory
        ...
        # 7. Loading existing data from the file
